              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header border-0">                        
                        <h3 class="card-title"><strong> ubicacion&nbsp;</strong> / Editar</h3>
                        <div class="card-toolbar">
                          <inertia-link :href="route('ubicaciones')" as="button" type="button" 
...
export default {
    ...
    methods:{
        update() {
            this.form.put(this.route('ubicaciones.update',this.ubicacion.id), {
