                ...
                <div class="row">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <inertia-link :href="route('areas.create')" class="
                            ...
                            <table class="
                                ...
                                <tbody>
                                    <tr v-for="area in areas.data" :key="area.id">
                                        ...
                                        <td class="pr-0">
                                            <!-- ACCION::EDITAR -->
                                            <inertia-link :href="route('areas.edit',area.id)" class="
                                                    btn
                                                    btn-icon
                                                    btn-light
                                                    btn-hover-primary
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            <div class="col-ms-12">
                                <pagination class="mt-6" :links="areas.links" />
                            </div>
                        </div>
                        <!-- PAginacion ends -->
                    </div>
...
<script>
    ...
    export default {
        ...
        watch: {
            params: {
                handler() {
                    this.$inertia.get(this.route('areas'), this.params, {
                        replace: true,
                        preserveState: true
                    });
                },
