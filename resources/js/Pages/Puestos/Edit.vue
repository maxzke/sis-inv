              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header border-0">                        
                        <h3 class="card-title"><strong> Puesto&nbsp;</strong> / Editar</h3>
                        <div class="card-toolbar">
                          <inertia-link :href="route('puestos')" as="button" type="button" 
...
export default {
    ...
    methods:{
        update() {
            this.form.put(this.route('puestos.update',this.puesto.id), {
