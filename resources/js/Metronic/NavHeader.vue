      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="header-logo">
              <a href="index.html">
                <img alt="Logo" src="https://tpv-store.test/assets/media/logos/logo-dark.png">
              </a>
            </div>
            <!--end::Header Logo-->
            <!--begin::Header Nav-->
            <ul class="menu-nav">
              <li class="menu-item">
                <!-- <a href="javascript:;" class="menu-link menu-toggle bg-secondary"> -->
                <inertia-link  :href="route('usuarios.index')" :active="route().current('usuarios.index')" class="menu-link">
                  <i class="fas fa-users"></i>
                  <span class="menu-text ml-1">Usuarios</span>
                </inertia-link>
              </li>
              <li
        ...
        <div class="topbar">          
          ...
          <div class="topbar-item">
            <div
              class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary"
