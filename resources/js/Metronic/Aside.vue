        ...
        >
          ...
          <ul class="menu-nav">
            <li class="menu-item" aria-haspopup="true">
              <!-- <a href="index.html" > -->
              <jet-nav-link  :href="route('template')" :active="route().current('template')">
            ...
            <li class="menu-item" aria-haspopup="true">
              <jet-nav-link  :href="'/categoria'">
                <i class="menu-icon flaticon-cogwheel-1"></i>
                <span class="menu-text">Categorias</span>
              </jet-nav-link>
            </li>
            <li class="menu-item" aria-haspopup="true">
              <jet-nav-link  :href="'/producto'">
                <i class="menu-icon flaticon-cogwheel-1"></i>
            ...
            <li class="menu-item" aria-haspopup="true">
              <jet-nav-link  :href="'/rol'">
                <i class="menu-icon flaticon-cogwheel-1"></i>
                <span class="menu-text">Roles</span>
              </jet-nav-link>
            </li>
            <li class="menu-item" aria-haspopup="true">
              <jet-nav-link  :href="'/permiso'">
                <i class="menu-icon flaticon-cogwheel-1"></i>
            ...
            >
              ...
              <div class="menu-submenu">
                ...
                <ul class="menu-subnav">
                  ...
                  <li class="menu-item" aria-haspopup="true">
                    <a href="features/widgets/forms.html" >
                      <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                      </i>
                      <span class="menu-text">Forms</span>
